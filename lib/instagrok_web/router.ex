defmodule InstagrokWeb.Router do
  use InstagrokWeb, :router

  import InstagrokWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {InstagrokWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: InstagrokWeb.Telemetry
    end
  end
